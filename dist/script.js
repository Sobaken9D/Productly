...
var Modal = /*#__PURE__*/function () {
  ...
  _createClass(Modal, [{
    ...
    value: function bindEvents() {
      this.modalCloseBtn.addEventListener('clcik', this.closeModal);
...
var renderArticlesToDom = function renderArticlesToDom() {
  var strategyWrapper = getStrategiesWrapper();
...
var addStrategyClickHandler = function addStrategyClickHandler() {
  document.querySelector('.strategy-wrapper').addEventListener('click', function (e) {
    if (e.target.closest('.strategy')) {
      ...
      var clickedStrategyDate = getClickedData(clickedStrategyId);
      renderArticleModalWindow(clickedStrategyDate);
    }
  });
};
